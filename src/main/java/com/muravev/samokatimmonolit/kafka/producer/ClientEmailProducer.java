...
@Slf4j
public class ClientEmailProducer {
    private static final String INVITE_LINK_PATTERN = "https://1304294-cu57808.tw1.ru/confirm/%s";
    ...
    public void sendInvite(UserInviteEntity invite) {
        ...
        EmailInviteClientMessage message = EmailInviteClientMessage.newBuilder()
                ...
                .build();
        log.info("{} {}", user.getEmail(), invite.getCode());
        kafkaTemplate.send(TopicName.EMAIL_INVITE_CLIENT, user.getEmail(), message);
    }
}
